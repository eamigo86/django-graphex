...
def test_results_is_not_graphene_pagination_field_on_native() -> None:
...
@pytest.mark.django_db
def test_cursor_page_info_graphene_field_not_built_on_native() -> None:
...
@pytest.mark.django_db
def test_native_container_results_totalcount_present() -> None:
...
@pytest.mark.django_db
def test_native_cursor_page_info_present() -> None:
...
@pytest.mark.django_db
def test_native_non_cursor_has_no_page_info() -> None:
