...
# =========================================================================== #
def test_inline_fragment_skips_foreign_type_with_gql_identity() -> None:
...
def test_inline_fragment_descends_on_matching_gql_name() -> None:
...
def test_inline_fragment_descends_via_graphene_meta_name_and_dunder_name() -> None:
...
def test_inline_fragment_descends_on_implemented_interface_name() -> None:
...
def test_inline_fragment_model_name_alone_never_skips_but_can_confirm() -> None:
...
def test_inline_fragment_malformed_condition_descends() -> None:
...
def test_collect_gfk_union_buckets_none_when_field_not_on_gql_type() -> None:
...
def test_collect_gfk_union_buckets_none_when_schema_is_none() -> None:
...
def test_collect_gfk_union_buckets_skips_unresolvable_fragment_keeps_member() -> None:
...
@requires_generic_prefetch
def test_collect_gfk_union_buckets_merges_split_member_selections() -> None:
...
@requires_generic_prefetch
def test_collect_gfk_union_buckets_skips_full_load_member() -> None:
...
def test_build_member_queryset_applies_select_alias_and_annotate() -> None:
...
@requires_generic_prefetch
@pytest.mark.django_db
def test_content_type_or_none_degrades_when_get_for_model_raises() -> None:
    ...
    Raises:
        RuntimeError: Not raised by the test itself; the mocked
            "get_for_model" side effect raises it internally so
            "_content_type_or_none" can exercise its degrade-to-None path.
    """
...
@requires_generic_prefetch
@pytest.mark.django_db
def test_build_generic_prefetch_returns_none_when_no_bucket_resolves() -> None:
    ...
    Raises:
        RuntimeError: Not raised by the test itself; the mocked
            "get_for_model" side effect raises it internally so every
            member's ContentType degrades to None.
    """
    from django.contrib.contenttypes.models import ContentType
...
@requires_generic_prefetch
@pytest.mark.django_db
def test_build_generic_prefetch_merges_columns_on_content_type_collision() -> None:
...
# =========================================================================== #
@pytest.mark.django_db
def test_narrow_plain_prefetch_emits_prefetch_for_alias_only_plan() -> None:
...
@pytest.mark.django_db
def test_narrow_plain_prefetch_bare_string_for_empty_plan() -> None:
...
# =========================================================================== #
def test_collect_prefetch_only_sets_descends_into_named_fragment_spread() -> None:
...
# =========================================================================== #
def test_get_member_models_interface_skips_input_entries_and_non_implementors() -> None:
...
# =========================================================================== #
def test_django_union_type_self_registers_into_global_registry_by_default() -> None:
    ...
    class _GlobalDefaultUnion(DjangoUnionType):
        class Meta:
            types = (_GlobalDefaultAccountType,)
...
def test_django_interface_type_self_registers_into_global_registry_by_default() -> None:
...
def test_inline_fragment_skips_unnamed_interface_in_interfaces_loop() -> None:
...
def test_inline_fragment_descends_when_model_has_no_usable_name() -> None:
...
# =========================================================================== #
@requires_generic_prefetch
def test_collect_gfk_union_buckets_merges_member_child_select_heads() -> None:
    ...
    class GfkCommentType(DjangoObjectType):
        class Meta:
            model = Track2GfkComment
            registry = reg
            unions = {"target": OrderTargetUnion}
