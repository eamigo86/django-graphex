"""Contract tests for the Ariadne benchmark docstring cleanup.
...
TARGET = ROOT / "benchmarks" / "libs" / "ariadne" / "bench_schema.py"
EXPECTED_OWNERS = frozenset(
    {
        "<module>",
        "_slice",
        "resolve_author_posts",
        "resolve_authors",
...
EXPECTED_EXECUTABLE_DIGEST = (
    "a08a51cefbefeb782ea05027b05f4afc9c3888b9f88db085af88c4960e3b11c1"
)
...
def test_ariadne_benchmark_docstrings_are_complete_and_runtime_neutral() -> None:
