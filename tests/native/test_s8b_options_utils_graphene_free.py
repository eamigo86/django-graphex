...
def test_types_no_top_level_graphene_baseoptions() -> None:
    """``types.py`` no longer imports ``graphene.types.base.BaseOptions``."""
...
def test_types_no_top_level_graphene_yank() -> None:
    """``types.py`` no longer imports ``graphene.types.utils.yank_fields_from_attrs``."""
    from django_graphex import types
...
def test_types_no_top_level_graphene_props() -> None:
    """``types.py`` no longer imports ``graphene.utils.props.props``."""
    from django_graphex import types
...
def test_types_no_top_level_graphene_warn_deprecation() -> None:
    """``types.py`` no longer imports ``graphene.utils.deprecated.warn_deprecation``."""
    from django_graphex import types
...
def test_types_dead_graphene_options_classes_removed() -> None:
    """The DEAD graphene-era Options classes are gone from ``types.py``.
...
def test_mutation_no_top_level_graphene_baseoptions() -> None:
    """``mutation.py`` no longer imports ``graphene.types.base.BaseOptions``."""
...
def test_mutation_no_top_level_graphene_props() -> None:
    """``mutation.py`` no longer imports ``graphene.utils.props.props``."""
    from django_graphex import mutation
...
def test_mutation_no_top_level_graphene_warn_deprecation() -> None:
    """``mutation.py`` no longer imports ``graphene.utils.deprecated.warn_deprecation``."""
    from django_graphex import mutation
...
def test_mutation_dead_graphene_options_class_removed() -> None:
    """``SerializerMutationOptions`` (graphene BaseOptions subclass) is removed."""
    from django_graphex import mutation
...
def test_schema_no_graphene_import_anywhere() -> None:
    """``schema.py`` has ZERO ``graphene`` imports (incl. TYPE_CHECKING block).
...
def test_native_props_matches_graphene_props_for_arguments_class() -> None:
    """``native.base._props`` extracts the same user attrs as graphene ``props``.
    ...
    """
    from django_graphex.native.base import _props
...
def test_legacy_input_deprecation_uses_stdlib_warnings() -> None:
    """The legacy-``Input`` deprecation path emits a stdlib ``DeprecationWarning``.
